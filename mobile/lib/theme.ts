...
export const Colors = {
  ...
  mood: {
    calm:        { bg: 'rgba(123,158,135,0.10)', text: '#4A6B55', border: 'rgba(123,158,135,0.30)', hex: '#7B9E87' },
    reflective:  { bg: 'rgba(107,124,110,0.10)', text: '#445548', border: 'rgba(107,124,110,0.30)', hex: '#6B7C6E' },
    hopeful:     { bg: 'rgba(196,149,106,0.10)', text: '#7A5A35', border: 'rgba(196,149,106,0.30)', hex: '#C4956A' },
    overwhelmed: { bg: 'rgba(61,107,122,0.10)',  text: '#2D4B5A', border: 'rgba(61,107,122,0.30)',  hex: '#3D6B7A' },
  },
} as const;
